...
class TestEmailTemplateAPI:
    ...
    def test_create_template(self, api_client):
        ...
        url = reverse('templates:template-list')
        data = {
            'name': 'new_template',
    ...
    def test_get_template(self, api_client, sample_template):
        ...
        url = reverse('templates:template-detail', kwargs={'name': sample_template.name})
    ...
    def test_validate_template(self, api_client, sample_template):
        ...
        url = reverse('templates:template-validate', kwargs={'name': sample_template.name})
        data = {
            'variables': {
                'variable': 'test',
                'user': {'name': 'John'}
    ...
    def test_extract_placeholders(self, api_client, sample_template):
        ...
        url = reverse('templates:template-placeholders', kwargs={'name': sample_template.name})
        response = api_client.get(url)
    ...
    def test_health_check(self, api_client):
        ...
        url = reverse('templates:template-health')
        response = api_client.get(url)
