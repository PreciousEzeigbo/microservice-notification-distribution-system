...
MIDDLEWARE = [
    ...
    "core.middleware.jwt.JWTMiddleware",
...
Supports:
- SQLite in-memory database for tests (CI-safe)
- PostgreSQL via DATABASE_URL for Docker/production
- SQLite file fallback for local development
"""

DATABASE_URL = os.getenv("API_GATEWAY_DATABASE_URL")
